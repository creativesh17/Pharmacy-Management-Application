...
<div class="row">
    <div class="col-lg-12">
        <form id="add-form" class="form-horizontal" method="post" action="{{url('admin/medcategories')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              <div class="card-header card-header-part">
                  <div class="row">
                      <div class="col-md-8">
                          <h3 class="card-title card-top-title"><i class="fa fa-gg-circle"></i> Add Category</h3>
                      </div>
              ...
              <div class="card-body card-form">
                ...
                <div class="form-group row custom-form-group">
                    ...
                    <div class="col-sm-7">
                      <textarea type="text" class="form-control" name="cate_note">{{old('cate_note')}}</textarea>
                    </div>
                </div>
              </div>
