...
@push('css')
    <style>
        ...
        table thead th:nth-child(6) { width: 20%;  }
    </style>
@endpush
@section('content')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card-header-part">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card-top-title"><i class="fa fa-gg-circle"></i> All Customer Information</h3>
                    </div>
                    <div class="col-md-4 text-right">
                        @if(Auth::user()->role_id <= 2)
                        <button  class="btn-delete btn btn-md btn-danger card-top-button mr-2" data-url="{{ route('admin.customer.destroy') }}" disabled><i class="fa fa-trash"></i> Delete</button>
                        @endif 
                        <a href="{{ route('admin.customers.create') }}" class="btn btn-md btn-secondary card-top-button"><i class="fa fa-plus-circle"></i> Add Customer</a>
                    </div>
                </div>
            </div>
