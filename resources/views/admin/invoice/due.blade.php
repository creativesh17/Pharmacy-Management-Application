...
@component('admin.includes.breadcrumb')
    <h4 class="pull-left page-title">Due Sales</h4>
    <ol class="breadcrumb pull-right">
        <li><a href="{{ url('admin/invoice/due') }}">Due Sales</a></li>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card-header-part">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card-top-title"><i class="fa fa-gg-circle"></i> All Due Sales Information</h3>
                    </div>
