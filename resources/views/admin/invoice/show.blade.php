                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="pull-left m-t-30">
                            <address>
                                <strong>{{ $settings->ph_name }}</strong>
                                <br>
                                <strong>Code: {{ $invoice->branch->branch_code }}</strong>
                                <br>
                                {{ $invoice->branch->branch_address }}
                                <br>
                        ...
                        <div class="pull-right m-t-30">
                            ...
                            <p class="m-t-10"><strong>Invoice No: </strong> #{{ $invoice->id }}</p>
                        </div>
                    </div>
                </div>
