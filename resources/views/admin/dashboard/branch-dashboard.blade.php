...
@section('title', 'Branchwise Dashboard')
...
@component('admin.includes.breadcrumb')
    <h4 class="pull-left page-title">Branchwise Dasboard</h4>
    <ol class="breadcrumb pull-right">
        <li><a href="{{ url('admin/branchwise/search?branch_code='.request()->branch_code) }}"> Dashboard </a></li>
