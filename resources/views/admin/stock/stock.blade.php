...
@component('admin.includes.breadcrumb')
    <h4 class="pull-left page-title">Stock Report</h4>
    <ol class="breadcrumb pull-right">
        <li><a href="{{ url('admin/stock/report') }}">Stock Report</a></li>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('admin.stock.stockReport.search') }}" method="get">
                            <div class="row">
                                @if (auth()->user()->role_id <= 2)
                                    <div class="col-sm-2">
