...
@section('title', 'Going To Be Expired')
...
@component('admin.includes.breadcrumb')
    <h4 class="pull-left page-title">Going To Be Expired</h4>
    <ol class="breadcrumb pull-right">
        <li><a href="{{ url('admin/stock/expired-soon') }}">Going To Be Expired</a></li>
    ...
    <div class="col-12">
        <div class="card">
                ...
                <div class="row">
                    <div class="col-md-8">
                        @if(auth()->user()->role_id <= 2)
                            <h3 class="card-title card-top-title"><i class="fa fa-gg-circle"></i> Going To Be Expired {{ request('branch') }}</h3>
                        @else
                            <h3 class="card-title card-top-title"><i class="fa fa-gg-circle"></i> Going To Be Expired {{ $branch->branch_code }}</h3>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('admin.stock.expired-soon.search') }}" method="get">
                            <div class="row">
                                @if (auth()->user()->role_id <= 2)
                                    <div class="col-sm-2">
