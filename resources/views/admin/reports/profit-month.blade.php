...
@push('css')
    <style>
        .font-profit-month th {
            font-size: 16px !important;
        }
        .font-profit-month td {
            font-size: 16px !important;
        }
        .font-profit-month span {
            font-size: 16px !important;
        }
    </style>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card-header-part">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card-top-title"><i class="fa fa-gg-circle"></i> Profit Statement For <span style="color: #08b4db;">{{ Carbon\Carbon::now()->format('M') }} <span> </h3>
                    </div>
        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-12"> 
                    <div class="card-body">
                        <div class="table-responsive font-profit-month">
